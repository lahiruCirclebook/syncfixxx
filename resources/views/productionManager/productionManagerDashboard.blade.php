    ...
    @if (\Illuminate\Support\Facades\Auth::id() == $id)
        ...
        <body data-sidebar="dark">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <h5 class="font-size-14 mb-0">No of Units</h5>
                                                            @if (!empty($noOfUnit))
                                                                <h5 class="mb-0">{{ $noOfUnit }}
                                                                </h5>
                                                            @else
                                                                <h5 class="mb-0">0</h5>
                                                            @endif
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <h5 class="font-size-14 mb-0">Meal Expenses</h5>
                                                            @if (!empty($mealExpenses))
                                                                <h5 class="mb-0">{{ $mealExpenses }}
                                                                </h5>
                                                            @else
                                                                <h5 class="mb-0">0</h5>
                                                            @endif
            ...
            <script>
                /*Pie Chart*/
                var options = {
                    series: [{{ $totalProduction }}, {{ $damageCount }}, {{ $mealExpenses }}],
                    labels: ["Total Production", "Damage Count", "Meal Expenses"],
                    colors: ["#3F3B6C", "#00ABB3", "#5A6EE6"],
                    chart: {
                        width: 550,
                        type: 'donut',
                    },
