                                    ...
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Daily
                                                        Production Summary</a></li>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <p class="text-muted fw-medium">Select Dates</p>
                                                    <form action="{{ url('filterEfficiencyStatus') }}" method="post"
                                                        enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        <div class="row">
                                                            {{-- <input type="text" class="form-control" name='vehicleId' id="vehicleId"
                                                       value="" hidden> --}}
