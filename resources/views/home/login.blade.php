            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <form action="{{url('login')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group auth-pass-inputgroup">
                                        ...
                                        <button class="btn btn-light" onclick="toggle()" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
                                    </div>
                                </div>
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>@<script>document.write(new Date().getFullYear())</script> By E-Rats GROUP </a></p>
                    </div>
                </div>
            </div>
            </div>
