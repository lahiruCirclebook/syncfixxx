                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col md 8">
                                                                ...
                                                                <input value="{{ $data->id }}" id="id"
                                                                    name="id" class="form-control" hidden>
                                                            </div>
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <a href="{{ url('/changePasswordView') . $data->id }}"
                                                                                class="btn btn-success waves-effect waves-light ">Change</a>
                                                                        </div>
                                                                    </div>
