        ...
        <body data-sidebar="dark">
                                    ...
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">Hr Department</li>
                                            </ol>
                                        </div>
                                                            ...
                                                            <div class="col-xxl-6">
                                                                <div>
                                                                    ...
                                                                    @if (!empty($inactiveEmployees))
                                                                        <h5 class="mb-0">{{ $inactiveEmployees }}
                                                                        </h5>
                                                                    @else
                                                                        <h5 class="mb-0">0</h5>
                                                                    @endif
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <h5 class="font-size-14 mb-0">Training Requirements</h5>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            <h5 class="font-size-14 mb-0">Out Labours</h5>
                                                            @if (!empty($outLabours))
            ...
            <script>
                ...
                options = {
                    ...
                    series: [{{ $expectedUmbrella }}, {{ $rejectUmbrella }}],
                    labels: ["Expected Umbrella", "Rejected Umbrella"],
                    colors: ["#50A5F1", "#C47AFF"],
                    legend: {
                        show: !0,
                        position: "bottom",
