        ...
        <body data-sidebar="dark">
            ...
            <div id="layout-wrapper">
                ...
                <div class="main-content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <button class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                                        data-bs-target="#employeeAddModal">Add New Employee</button>
                                </div>
                            </div>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @if ($role == 'Admin')
                                                                            <button
                                                                                ...
                                                                                data-department="{{ $item->department }}"
                                                                                data-unit="{{ $item->unit }}"
                                                                                data-designation="{{ $item->designation }}">Edit</button>
                                                                            <a href="{{ url('deleteEmployee') . $item->randomEmpId }}"
                    ...
                    <div id="employeeAddModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('newEmployee') }}" method="post"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nicNo"
                                                        name="nicNo"oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="department" id="department" class="form-select"
                                                        ...
                                                        <option value="Finansial Accounting">Finansial Accounting
                                                        </option>
                    ...
                    <div id="employeeEditModal" class="modal fade" tabindex="-1" role="dialog"
                        aria-labelledby="employeeEditModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('editEmployee') }}" method="post"
                                        enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <input type="text" class="form-control" id="randomEmpId"
                                            name="randomEmpId" hidden>
            ...
            <script>
                $('#employeeEditModal').on('show.bs.modal', function(event) {
                    ...
                    let dateOfBirth = button.data('dateofbirth')
